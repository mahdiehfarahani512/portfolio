...
<h1 className="font-bold ">
  {/* موبایل */}
  <span className="block lg:hidden text-white text-[66px]">
    Mahdieh <br />
    Farahani.
  </span>
...
<div className=" flex gap-5 hover:cursor-pointer mt-10">
...
export default Mahdiehfarahani